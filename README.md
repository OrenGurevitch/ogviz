...
They are grouped by what they are FOR, and each pair's COLUMN WIDTHS are solved from the two
figures' aspect ratios so both cells come out the same height. Equal columns do not: a 0.95-ratio
panel beside a 1.25-ratio grid differs by 121 px, which reads as an accident rather than a pair.
...
<tr>
<td colspan="2"><img src="examples/out/12_coupling_panels.png" width="100%"><br><sub><code>coupling_panels</code> — scatters over forest plots; full width because six panels in a half column are unreadable</sub></td>
</tr>
</table>
