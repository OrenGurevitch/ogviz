...
They are grouped by what they are FOR, and paired by shape within each group: a 0.85-ratio grid
beside a 1.98-ratio strip in equal columns makes one cell over twice the height of its neighbour,
which reads as an accident rather than a comparison.
...
<td width="50%"><img src="examples/out/02_display_units.png" width="100%"><br><sub><code>display_scale</code> — held in ppm, drawn in ppb</sub></td>
</tr>
<tr>
...
<td width="50%"><img src="examples/out/18_stft_spectrogram.png" width="100%"><br><sub><code>spectrogram</code> — an STFT, with the scale that makes it a measurement</sub></td>
</tr>
</table>
...
<td width="50%"><img src="examples/out/17_controlled_comparison.png" width="100%"><br><sub>one bar that is not comparable, said on the axis</sub></td>
</tr>
<tr>
...
<tr>
<td colspan="2"><img src="examples/out/10_horizontal.png" width="100%"><br><sub><code>orientation="horizontal"</code>, for long names — full width, because at 2.77:1 a half column leaves a sliver</sub></td>
</tr>
</table>
...
<table>
<tr>
<td width="50%"><img src="examples/out/14_effect_heatmap.png" width="100%"><br><sub><code>effect_heatmap</code> — diverging, stars, missing cells</sub></td>
<td width="50%"><img src="examples/out/16_comparison_table.png" width="100%"><br><sub><code>table_panel</code> — highlighted row or column, cell tone</sub></td>
</tr>
</table>
